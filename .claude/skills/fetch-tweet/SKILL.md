---
name: fetch-tweet
description: 사용자가 "트윗 가져와", "트윗 번역", "X 게시글 읽어줘", "tweet fetch", "트윗 내용", "트윗 원문"이라고 요청하거나 X/Twitter URL(x.com, twitter.com)을 제공하고 트윗 내용을 읽기, 번역, 분석하길 원할 때 사용한다. 다른 스킬이 트윗 텍스트를 프로그래밍 방식으로 가져와야 할 때도 유용하다.
---
